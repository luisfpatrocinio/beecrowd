...
# leia cada um dos valores de X, encontre o menor elemento deste vetor e a sua posição dentro do vetor, mostrando esta informação.
...
def main():
    ...
    # Processamento
    menor_valor = encontrar_menor_valor(vetor)
    posicao = encontrar_posicao(menor_valor, vetor)

    # Saída
    print(f"Menor valor: {menor_valor}")
    print(f"Posicao: {posicao}")

def encontrar_menor_valor(vetor):
    menor_valor = vetor[0]
...
def encontrar_posicao(menor_valor, vetor):
